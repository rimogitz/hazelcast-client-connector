...
/**
 * A <code>HazelcastClientConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link HazelcastClientConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2019-01-05T01:47:27+00:00", comments = "Build UNNAMED.2793.f49b6c7")
public class HazelcastClientConnectorLifecycleInjectionAdapter
    extends HazelcastClientConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(HazelcastClientConnectorLifecycleInjectionAdapter.class);
