...
public class SetMessageProcessorDebuggable
    extends SetMessageProcessor
    implements DebugInfoProvider
{


    public SetMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("value", "Value", (java.lang.String.class), value, muleEvent));
