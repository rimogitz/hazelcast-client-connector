...
/**
 * GetMessageProcessor invokes the {@link org.mule.modules.hazelcastclient.HazelcastClientConnector#get(java.lang.String)} method in {@link HazelcastClientConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedKey = ((String) evaluateAndTransform(getMuleContext(), event, GetMessageProcessor.class.getDeclaredField("_keyType").getGenericType(), null, key));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((HazelcastClientConnector) object).get(_transformedKey);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at HazelcastClientConnector at get retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
